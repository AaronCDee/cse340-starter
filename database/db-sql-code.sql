...
-- Create inventory favorite
CREATE TABLE public.inventory_favorite
(
	inventory_favorite_id INT GENERATED BY DEFAULT AS IDENTITY,
	account_id integer NOT NULL,
	inventory_id integer NOT NULL,
	CONSTRAINT inventory_favorite_pk PRIMARY KEY (inventory_favorite_id)
);

-- Create relationship between `account` and `inventory_favorites` tables
ALTER TABLE IF EXISTS public.inventory_favorite
    ADD CONSTRAINT fk_account FOREIGN KEY (account_id)
    REFERENCES public.account (account_id) MATCH SIMPLE
    ON UPDATE CASCADE
    ON DELETE NO ACTION;

-- Create relationship between `inventory` and `inventory_favorites` tables
ALTER TABLE IF EXISTS public.inventory_favorite
    ADD CONSTRAINT fk_inventory FOREIGN KEY (inventory_id)
